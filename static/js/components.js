...
Vue.component('force-map', {
    ...
    methods: {
        selectableForceDirectedGraph () {
            ...
            var title = vis.append('g').attr('class', 'title').selectAll('circle')
            ...
            async function initData () {
                let graph = {};
                await axios.get('http://localhost:8848/api/force/demo')
    ...
    mounted: function () {
        this.selectableForceDirectedGraph()
    },
    watch: {
        count: function () {
            this.selectableForceDirectedGraph()
